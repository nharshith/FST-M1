...
public class Activity13 {
	...
	public static void main(String[] args) {
		...
		WebElement secondCell = driver.findElement(By.xpath("//table[contains(@class, 'table-auto')]/tbody/tr[2]/td[2]"));

		System.out.println("Second row second column value: " +secondCell.getText());
